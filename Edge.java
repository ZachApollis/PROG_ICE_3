...
public class Edge extends JComponent implements Comparable<Edge> {
    ...
    public static boolean edgeExists(Vertex vertex1, Vertex vertex2) {
    ...
    // Checks if the edge connects a vertex to itself

    public static boolean isSelfLoop(Vertex vertex1, Vertex vertex2) {
